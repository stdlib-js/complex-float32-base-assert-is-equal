...
```javascript
import isEqual from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-base-assert-is-equal@esm/index.mjs';
```
...
```javascript
import isEqual from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-base-assert-is-equal@v0.1.2-esm/index.mjs';
```
